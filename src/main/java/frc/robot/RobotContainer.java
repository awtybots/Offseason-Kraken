...
public class RobotContainer {
  ...
  public RobotContainer() {
    ...
    NamedCommands.registerCommand("Control All Shooting",
        ...
        }, Set.of(m_shooter, m_conveyor, m_kicker, m_intake, m_rollers, m_hood, m_pushout)));
        ...
        Commands.defer(() -> {
          ...
          return Commands.sequence(
              Commands.parallel(
                  ...
                  m_pushout.AgitateCommand(),
                  m_intake.runIntakeCommand()));
        }, Set.of(m_shooter, m_conveyor, m_kicker, m_intake, m_rollers, m_hood, m_pushout)).withTimeout(4.0));
